module View
  class Board < Qt::Widget
    ...
    def initialize(parent = nil)
      super
      @theme = Theme.new
      @theme.load_squares(FILE_PATH + "/themes/simple.png")
      @theme.load_pieces(FILE_PATH + "/themes/pieces.png")
      @theme.load_highlights(FILE_PATH + "/themes/composed-highlight.png")
